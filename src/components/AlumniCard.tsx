...
const AlumniCard:React.FC<{data: any}> = ({ data }) => (
  <div className="w-96 min-h-80 relative flex flex-col justify-between border-[1px] overflow-visible border-solid border-opacity-10 border-black shrink-0 shadow-lg mx-4">
    ...
    <div className="flex items-center p-4 border-t-[1px] border-black border-opacity-10">
      <img src={data.image} alt="alumni" className="h-8 w-8 object-cover rounded-full object-top" />
